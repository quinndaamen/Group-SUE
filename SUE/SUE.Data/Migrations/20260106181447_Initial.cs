        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SensorTypes = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SensorNodes_Households_HouseholdId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SensorNodeId = table.Column<Guid>(type: "uuid", nullable: false),
                    Timestamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Temperature = table.Column<double>(type: "double precision", nullable: true),
                    Humidity = table.Column<double>(type: "double precision", nullable: true),
                    AQI_MQ135 = table.Column<double>(type: "double precision", nullable: true),
                    EnergyUsage = table.Column<double>(type: "double precision", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Measurements_SensorNodeId",
                table: "Measurements",
                column: "SensorNodeId");

            migrationBuilder.CreateIndex(
                name: "IX_SensorNodes_HouseholdId",
                table: "SensorNodes",
                column: "HouseholdId");
